...
object SignUp extends Controller {
  ...
  val signupForm: Form[User] = Form(
    ...
    // The mapping signature amtches the UserProfile case class signature,
    // so we can use default apply/unapply functions here
      (UserProfile)(UserProfile.unapply),
    ...
    {
      // Binding: Create a User from the mapping result (ignore the second password and accept field)
